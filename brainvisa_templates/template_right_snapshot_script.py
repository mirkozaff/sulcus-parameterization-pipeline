...
#res = anaSulciSnapshot.main( ['-g', u'BVDIR/SUBJECT/t1mri/default_acquisition/default_analysis/folds/3.1/default_session_auto/LSUBJECT_default_session_auto.arg',
#'--label-mode', 'label', '-m', u'BVDIR/SUBJECT/t1mri/default_acquisition/default_analysis/segmentation/mesh/SUBJECT_Lwhite.gii',
...
#'--size', '10000,10000',
#'-t', u'BVDIR/SUBJECT/t1mri/default_acquisition/registration/RawT1-SUBJECT_default_acquisition_TO_Talairach-ACPC.trm'] )

import imp
anasul = imp.find_module( "anaSulciSnapshot", [ "/Applications/brain_visa/bin/real-bin" ] )
...
transfile='/Applications/brain_visa/share/brainvisa-share-4.5/nomenclature/translation/sulci_model_2008.trl'
orientation='SIDE'
trm_name='BVDIR/SUBJECT/t1mri/default_acquisition/registration/RawT1-SUBJECT_default_acquisition_TO_Talairach-ACPC.trm'
graphname='BVDIR/SUBJECT/t1mri/default_acquisition/default_analysis/folds/3.1/default_session_auto/RSUBJECT_default_session_auto.arg'
meshname='BVDIR/SUBJECT/t1mri/default_acquisition/default_analysis/segmentation/mesh/SUBJECT_Rwhite.gii'
imagename='/Users/researchassistant/Desktop/SZ_snapshots/right/right_lateral_SUBJECT.jpg'
selected_sulci=''
wingeom=[1000,1000]
label_state='label'
hiename='/Applications/brain_visa/share/brainvisa-share-4.5/nomenclature/hierarchy/sulcal_root_colors.hie'
